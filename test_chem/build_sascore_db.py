#!/usr/bin/env python
#
# File to build a database of fragement scores for the Synthetic
    ...
    """
        ...
        Returns:
            (Namespace object): Parsed arguments in argparse Namespace
                                object.
        """
    parser = argparse.ArgumentParser(description='Generate fragement scores'
                                                 ' data for Synthetic'
...
def extractFragments(molfile: str, skip_stand: bool) -> Optional[list[tuple[int, int]]]:
    ...
    for i, mol in enumerate(suppl):
        ...
        if norm_mol is None:
            continue
        fp = rdMolDescriptors.GetMorganFingerprint(norm_mol, radius=2)
